    ...
    <div class="container create-account">
        ...
        <div class="row align-items-center d-flex justify-content-center">
            <div class="col-md-5 form-container">
                <form action="{{ route('login') }}" method="POST" id="login" accept-charset="UTF-8">
                    @csrf
                    <div class="mb-3">
                    ...
                    <p class="login-switch"><a href="{{ route('register') }}"><b>Register now</b></a></p>

                </form>
            </div>

            <div class="col-md-6 create-account-img offset-md-1 d-none d-md-block">
                <img src="{{asset("img/profile_urahara.jpg")}}" alt="account">
            </div>
        </div>

        <div class="row d-flex justify-content-center">
                <button form="login" type="submit" class="create-account-button btn-primary btn-block">LOG IN</button>
        </div>
